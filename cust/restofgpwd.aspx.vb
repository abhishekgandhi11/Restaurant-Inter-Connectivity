...
Partial Class cust_restofgpwd
    ...
    Protected Sub btnsearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnsearch.Click
        Try
            cmd.CommandText = "select email from restomaster where email= '" & txtemail.Text & "' "
            cmd.Connection = conn
            conn.Open()
        ...
        Try
            cmd.CommandText = "select contactno from restomaster where email= '" & txtemail.Text & "' "
            cmd.Connection = conn
            conn.Open()
        ...
        Try
            cmd.CommandText = "select restonm from restomaster where email= '" & txtemail.Text & "' "
            cmd.Connection = conn
            conn.Open()
            Session("restonm") = cmd.ExecuteScalar()
            If Session("restonm") = Nothing Then
        ...
        Try
            cmd.CommandText = "select rpass from restomaster where email= '" & txtemail.Text & "' "
            cmd.Connection = conn
            conn.Open()
            Session("pass") = cmd.ExecuteScalar()
            Session("msg") = "Hello Dear Owner of " + Session("restonm") + " restaurant your password of " + Session("emailid") + " email id is " + Session("pass") + " City Corner..."
