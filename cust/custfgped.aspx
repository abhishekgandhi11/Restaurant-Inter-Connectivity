<%@ Page Title="" Language="VB" MasterPageFile="~/cust/custMasterPage.master" AutoEventWireup="false" CodeFile="custfgped.aspx.vb" Inherits="cust_custfgped" %>
            ...
            <div class="col-md-6">
              ...
              <!-- Start Contact Form -->
                ...
                <div class="form-group">
                  <div class="controls">
                    <asp:TextBox ID="txtemail" runat="server" class="form-control" placeholder="Enter your e-mailid"></asp:TextBox>(Case sensitive)
